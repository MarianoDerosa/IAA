...
if not os.path.exists('plate_detection_results'):
    os.makedirs('plate_detection_results')
...
for image_path in TEST_IMAGE_PATHS:
    image_result_name = "plate_detection_results/inference" + str(INFERENCE) +".png"
    print("Processing image " + str(INFERENCE + 1) + " of " + str(len(TEST_IMAGE_PATHS)) + "...")
    INFERENCE += 1
